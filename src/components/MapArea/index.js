...
const MapArea = ({ lat, lng, citiesCases, setTooltipContent }) => {
    ...
    const [circleHeight, setCircleHeight] = useState(8);
    ...
    const getMarkerSize = () => {
        ...
        setCircleHeight(size);

         
       let element=document.querySelector('.circle').setAttribute("style", "height:"+size+"px;width:"+size+"px");
    ...
    return (
        ...
        >
            ...
            <Styled.ContainerMarker
                ...
                data-tip='Você'
            >
                <Circle type='you' className="circle" />
                <ReactTooltip />
            </Styled.ContainerMarker>
